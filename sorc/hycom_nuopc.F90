!>
!! @mainpage HYCOM NUOPC Cap
!! @author Fei Liu (fei.liu@gmail.com)
!! @date 1/12/17 Original documentation
!!
!! @tableofcontents
!!
!! @section Overview Overview
!!
!! **This HYCOM cap has been tested with versions X,Y,Z of HYCOM.**
!!
...
!!
!! The HYCOM cap Fortran module contains a set of subroutines that are required
...
!! HYCOM model is able to accept a precipitation rate when coupled to an atmosphere
...
!! HYCOM model.  Because models may uses different variable names for physical
...
!!
!! Two key initialization phases that appear in every NUOPC cap, including this HYCOM
...
!! Init     | [InitializeRealize] (@ref hycom::initializerealize)                | Creates an ESMF_Grid for the HYCOM grid as well as ESMF_Fields for import and export fields
!! Run      | [ModelAdvance] (@ref hycom::modeladvance)                          | Advances the model by a timestep
!! Final    | [Finalize] (@ref hycom::finalize)                                  | Cleans up
!!
...
!!
!! **HOW TO BUILD AND INSTALL CAP/HYCOM**
!!
...
!! @section References 
!! 
!! - [HYCOM Home Page] (https://hycom.org/)
!!
!!
