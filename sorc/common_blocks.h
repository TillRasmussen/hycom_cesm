...
c
     ...
     &       ttot,tcot,tctot,back_l_0
      save  /gissr3/
c
      real*8           area,avgbot,watcum,empcum,wndrep
      common/varblsd/  area,avgbot,watcum,empcum,wndrep
      save  /varblsd/
c
      real            time,delt1,dlt,
...
c --- 'hugel'  = large number used to indicate land points
c
      real          tenm,onem,tencm,onecm,onemm,qonem,
     &              g,thref,qthref,spcifh,epsil,hugel,radian,pi
